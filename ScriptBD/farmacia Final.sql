...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-09-2022 a las 06:41:01
...
(1, 'Aspirina 650 mg', 145, '0.23'),
(2, 'Apronax 400 mg', 500, '0.40'),
(3, 'Omeprazol 20 mg', 400, '0.22'),
(4, 'Paracetamol 500 mg', 635, '0.20'),
...
(5, 'JBD', 'Marcos Males', 'marcosmales@epn.edu.ec', NULL, '1234');
...
--
ALTER TABLE `cab__nvtas`
  MODIFY `CODNV` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `det_nvtas`
  MODIFY `CODDET` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
